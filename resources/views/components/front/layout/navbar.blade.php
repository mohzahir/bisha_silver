<div>
    <nav class="navbar navbar-expand-lg">
        ...
        <div id="navigation" class="collapse navbar-collapse">
            ...
            <li class="nav-item"><a href="#" class="nav-link active"> الرئيسيه </a></li>
            <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link"> الرجال <b class="caret"></b></a>
            ...
            <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link">النساء<b class="caret"></b></a>
                <ul class="dropdown-menu megamenu">
                <li>
                    <div class="row">
                    <div class="col-md-6 col-lg-3">
            ...
            <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link">القالب<b class="caret"></b></a>
                <ul class="dropdown-menu megamenu">
                <li>
                    <div class="row">
                    <div class="col-md-6 col-lg-3">
