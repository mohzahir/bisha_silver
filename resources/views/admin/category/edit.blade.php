                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div>
                                                    <span class="btn default btn-file">
                                                        <input type="file" name="photo" id="photo" class="file" data-initial-preview="<img src='{{ asset($category->photo) }}' class='file-preview-image file-preview-image kv-preview-data rotate-1 file-zoom-detail'>">
                                                        @error('photo')
