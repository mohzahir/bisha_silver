                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="sub_category_id" id="sub_category_id" class="form-control">
                                                    ...
                                                    <option {{ $sub_category->id == old('sub_category_id') ? 'selected' : '' }} value="{{ $sub_category->id }}">{{ $sub_category->category->name }} -> {{ $sub_category->name }} </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="price" value="{{ old('price') }}" name="price" type="text" class="form-control" placeholder="100">
                                                @error('price')
                                                <div class="alert alert-danger">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="discount" value="{{ old('discount') }}" name="discount" type="text" class="form-control" placeholder="0">
                                                @error('discount')
                                                <div class="alert alert-danger">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="after_discount" value="{{ old('after_discount') }}" name="after_discount" type="text" class="form-control disabled" disabled placeholder="100">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="qty" value="{{ old('qty') }}" name="qty" type="text" class="form-control" placeholder="100">
                                                @error('qty')
                                                <div class="alert alert-danger">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input id="sku" value="{{ old('sku') }}" name="sku" type="text" class="form-control" placeholder="100">
                                                @error('sku')
                                                <div class="alert alert-danger">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input id="title" value="{{ old('title') }}" name="title" type="text" class="form-control" placeholder="قم بإدخال إسم المنتج هنا">
                                                @error('title')
                                                <div class="alert alert-danger">
                                                    {{ $message }}
                                                </div>
